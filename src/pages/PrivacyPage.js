    ...
    <div className="privacy-page">
      ...
      <div data-custom-class="body">
        ...
        <ul>
          <li data-custom-class="body_text" style={{lineHeight: '1.5'}}>
            <span style={{fontSize: '15px', color: 'rgb(89, 89, 89)'}}>
              <span data-custom-class="body_text">
                Visit our website at <a href="http://www.adsperform.com" target="_blank" data-custom-class="link">http://www.adsperform.com</a> or any website of ours that links to this Privacy Notice
              </span>
            </span>
          </li>
        </ul>
        ...
        <div style={{lineHeight: '1.5'}}>
          ...
          <a data-custom-class="link" href="https://app.termly.io/notify/2577f5a6-c838-4141-95f1-3c0417f778b3" rel="noopener noreferrer" target="_blank">
            <span style={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}>
        ...
        <div style={{lineHeight: '1.5'}}>
          <span style={{fontSize: '15px'}}>
            <a data-custom-class="link" href="#infominors">
              <span style={{color: 'rgb(0, 58, 250)'}}>10. DO WE COLLECT INFORMATION FROM MINORS?</span>
            </a>
          </span>
        </div>
        ...
        <div style={{lineHeight: '1.5'}}>
          <span style={{fontSize: '15px'}}>
            <span style={{color: 'rgb(0, 58, 250)'}}>
              <a data-custom-class="link" href="#privacyrights">11. WHAT ARE YOUR PRIVACY RIGHTS?</a>
            </span>
          </span>
        </div>
        ...
        <div style={{lineHeight: '1.5'}}>
          <span style={{fontSize: '15px'}}>
            <a data-custom-class="link" href="#DNT">
              <span style={{color: 'rgb(0, 58, 250)'}}>12. CONTROLS FOR DO-NOT-TRACK FEATURES</span>
            </a>
          </span>
        </div>
        ...
        <div style={{lineHeight: '1.5'}}>
          <span style={{fontSize: '15px'}}>
            <a data-custom-class="link" href="#uslaws">
              <span style={{color: 'rgb(0, 58, 250)'}}>13. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span>
            </a>
          </span>
        </div>
        ...
        <div style={{lineHeight: '1.5'}}>
          <span style={{fontSize: '15px', color: 'rgb(89, 89, 89)'}}>
            <span data-custom-class="body_text">
              <strong>Contact Information:</strong> If you have questions about this Privacy Notice, please contact us at contact@adsperform.com
            </span>
          </span>
        </div>
      </div>
